        ...
        <div class="form-container">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input-container">
                    <input type="text"   disabled id="dono" value="{{$carro->sobre}}" placeholder="Nome do proprietário">
            ...
            <div class="form-group">
                ...
                <div class="input-container">
                    <input type="text"   disabled id="dono" value="{{$carro->dono}}" placeholder="Nome do proprietário">
                    <i class="fas fa-user input-icon"></i>
                </div>
            </div>
            ...
            <div class="buttons">
                <button type="button" class="btn-submit" id="meu">
                    <i class="fas fa-save btn-icon"></i> deletatar Veículo
                </button>
            </div>
        </div>
    </div>
